        ...
        <div class="col-sm-12">
            <section class="checkout_inner_page">
                ...
                <div class="checkout_inner_details">
                            ...
                            <div class="row">
                                ...
                                <div class="common_col">
                                    <div class="single-input-fields">
                                        <div class="g-recaptcha " id="recaptcha_1" data-sitekey="6Le-tpAaAAAAAGsaF7AictdkHgZGyLzVzkLEGQDS"></div>
                    ...
                    <div class="common_box hidden-xs" style="width: 30%;">
                        <h3><strong>Log Into Your Account</strong></h3>
                        <div class="common_details">
                            <form class="new_user" id="login_user" action="{{ route('login') }}" method="post">
                            @csrf
...
<script type="text/javascript">
    var onloadCallback = function() {
        ...
        'sitekey' : '6Le-tpAaAAAAAGsaF7AictdkHgZGyLzVzkLEGQDS',
        });
    };
</script>
