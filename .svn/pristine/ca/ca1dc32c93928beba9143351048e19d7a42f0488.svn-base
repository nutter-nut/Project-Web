...
Route::get('/products/{prodCode}/{uomCode}', [ "uses" => "IndexController@productDetal", 'as' => 'productDetal' ]);
...
// *product menu group
Route::get('/admin/product/menu/group', ["uses"=>"Admin\Product\ProductMenuGroupController@index", 'as' => 'adminProductMenuGroup'])->middleware('restricToEmployee');

Route::post('/admin/product/menu/group/insert', ["uses"=>"Admin\Product\ProductMenuGroupController@productMenuGroupInsert", 'as' => 'productMenuGroupInsert'])->middleware('restricToEmployee');

Route::get('/admin/product/menu/group/edit/{id}', ["uses"=>"Admin\Product\ProductMenuGroupController@productMenuGroupEdit", 'as' => 'productMenuGroupEdit'])->middleware('restricToEmployee');

Route::post('/admin/product/menu/group/update/{pmId}&pmCode={pmCode}', ["uses"=>"Admin\Product\ProductMenuGroupController@productMenuGroupUpdate", 'as' => 'productMenuGroupUpdate'])->middleware('restricToEmployee');

Route::get('/admin/product/menu/group/delete/{pmId}', ["uses"=>"Admin\Product\ProductMenuGroupController@productMenuGroupDelete", 'as' => 'productMenuGroupDelete'])->middleware('restricToEmployee');

Route::get('/admin/product/menu/group/getProduct/{pmCode}', ["uses"=>"Admin\Product\ProductMenuGroupController@getProductsWithMenuGroup", 'as' => 'getProductsWithMenuGroup'])->middleware('restricToEmployee');

Route::get('/admin/product/menu/group/getProducts/{pmCode}', ["uses"=>"Admin\Product\ProductMenuGroupController@getProductsMenu", 'as' => 'getProductsMenu'])->middleware('restricToEmployee');

Route::get('/admin/product/menu/group/insert_product/{pmCode}/{pordCode}', ["uses"=>"Admin\Product\ProductMenuGroupController@insertProduct", 'as' => 'insertProduct'])->middleware('restricToEmployee');

Route::get('/admin/product/menu/group/delete_product/{pmCode}/{pordCode}', ["uses"=>"Admin\Product\ProductMenuGroupController@deleteProduct", 'as' => 'deleteProduct'])->middleware('restricToEmployee');
