                        ...
                        <table id="table_id" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="@if($userData->isAdmin()) display:none; @endif">{{ __('login.page.order.display.status') }}</th>
                                    ...
                                    <th style="@if(!$userData->isAdmin()) display:none; @endif">จ่าหน้าซอง</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr style="@if($items['order']['status_payment']==1) background-color: #f0f0f0; @endif">
                                    ...
                                    <td style="@if($userData->isAdmin()) display:none; @endif">@if(\Session::get('locale') != 'th') {{ $items['status']['status_en'] }} @else {{ $items['status']['status_th'] }} @endif</td>
                                    ...
                                    <td style="@if(!$userData->isAdmin()) display:none; @endif">
                                        @if($userData->isAdmin() && $items['order']['status_payment'] != 0 && $items['order']['user_employee'] != '0')
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                            <a href="{{ route('envelopePdf', [ 'id' => $items['order']['id']]) }}" class="btn btn btn-outline-info" role="button" target="_blank" >
                                            <i class="fa fa-print"></i> {{ __('login.page.order.display.print') }}</a>
                                        </div>
                                        @endif
                                    </td>
                                </tr>
