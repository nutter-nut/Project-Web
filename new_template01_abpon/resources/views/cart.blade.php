        ...
        <div id="cart">
            ...
            <div class="col-sm-12">
                <section class="shopping_cart">
                    ...
                    <form name="FormAddress" class="contact_form" action="{{ route('sendOrder') }}" method="POST" novalidate="novalidate">
                    {{ csrf_field() }}
                        <div class="related_product bg-sendorder px-3">
                            <div class="col-md-4">
                                <div class="col-5 float-right" >
                                    <div class="input-group">
                                        <select name="address_selete" id="address_selete" onchange="addressSelete(this.value)" class="form-control form-control-sm" style="border-radius: 5px;">
