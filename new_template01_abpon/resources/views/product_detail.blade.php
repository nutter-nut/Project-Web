                ...
                <div class="product_details pb-5">
                        ...
                        <div class="row pt-5" style="margin: 0px;">
                            <div class="col-sm-6 col-md-12 col-lg-5 col-xl-6">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">{{ __('index.product_details.unit') }}</th>
                                            <th scope="col">{{ __('index.product_details.price') }}({{ __('index.product_details.baht') }})</th>
                                            <th scope="col">{{ __('index.product_details.number_piece') }}</th>
                                            <!-- <th scope="col">{{ __('index.product_details.stock') }}</th> -->
                                    ...
                                    <tbody>
                                        @foreach($data['get_uomname'] as $key => $item)
                                            <tr>
                                                ...
                                                <td><em>{{ $item['prodUnitRatio'] }} {{ __('index.product_details.piece') }}</em></td>
                                                <!-- <td><em>{{ $data['stock_now']['stock'] }} {{ __('index.product_details.piece') }}</em></td> -->
                            ...
                            <div class="col-sm-6 col-md-12 col-lg-7 col-xl-6">
                                <div class="add-qty-box">
                                    <form class="form-horizontal" action="{{ route('AddToCartProduct', [ 'prodCode' => $data['get_data']->prodCode ]) }}" method="GET">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8" style="display: initial;">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="rating-block">
                            ...
                            <div class="row pt-3" style="justify-content: center;padding: 11px;">
                                ...
                                @if($data['review_count_star'] != null)
                                    @foreach(array_reverse($data['review_count_star']) as $key => $item)
                                        <div class="pull-left">
                                            <div class="pull-left" style="width:35px; line-height:1;margin-top: -2px;">
                                                <div style="height:9px; margin:5px 0;"> {{ 5 - $key }} <span class="glyphicon glyphicon-star"></span></div>
                                            </div>
                                            <div class="pull-left" style="width:158px;">
                                            ...
                                            <div class="pull-right" style="margin-left:10px;margin-top: 3px;">{{ $item[0] }} &nbsp;&nbsp;</div>
                                        </div>
                                    @endforeach
                                @else
                                    @for ($i = 0; $i < 5; $i++)
                                        <div class="pull-left">
                                            ...
                                            <div class="pull-right" style="margin-left:10px;margin-top: 3px;">0 &nbsp;&nbsp;</div>
                                        </div>
                                    @endfor
                                @endif
                            </div>
